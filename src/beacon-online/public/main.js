...
// src/beacon-online/web/main.ts
var $ = (s) => document.querySelector(s);
var listId = $("#list-id");
var listBrain = $("#list-brain");
var inputId = $("#input-id");
var inputBrain = $("#input-brain");
var btnSendId = $("#send-id");
...
function ensureKey() {
  ...
  if (k && npubEl)
    npubEl.textContent = k.npub;
  return k;
}
async function fetchMessages(box, pubkey) {
...
inputId?.addEventListener("keydown", (e) => {
  if (e.key === "Enter")
    btnSendId?.dispatchEvent(new Event("click"));
});
inputBrain?.addEventListener("keydown", (e) => {
  if (e.key === "Enter")
    btnSendBrain?.dispatchEvent(new Event("click"));
});
ensureKey();
refreshAll().catch(console.error);
